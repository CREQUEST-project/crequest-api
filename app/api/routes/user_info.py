...
from models.users import ChangePassword, ForgotPassword, UserOut
...
def update_user_info(
    ...
    return UserController.update_user_info(
        session, user_id, email, location, phone, file
    )
...
def forgot_password(
    session: SessionDep, user_id: int, data_in: ForgotPassword
) -> Message:
